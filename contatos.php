            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <p class="box-contacts-link"><a href="http://api.whatsapp.com/send?1=pt_BR&phone=5531975275084">31 97527-5084</a></p>
            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"><a href="#">Rua 50, Bairro Santa Efigência, Belo Horizonte 30515-522</a></p>
                </div>
              </article>
            </div>
            <div class="col-sm-8 col-md-6 col-lg-4">
